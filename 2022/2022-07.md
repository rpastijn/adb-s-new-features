...
- Fill in the details for user\_ocid, fingerprint and tenancy\_ocid from the configuration file preview you saved in your text editor in the previous step. The command now should look similar to this:
